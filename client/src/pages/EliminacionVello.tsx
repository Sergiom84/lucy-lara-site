      ...
      <main className="pt-32 pb-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <motion.div 
            ...
            className="text-center bg-gradient-to-r from-accent to-accentDark rounded-xl p-8 text-white mt-16"
          >
            <h3 className="font-playfair text-2xl font-semibold mb-4">
              ¿No sabes qué método elegir?
            </h3>
            <p className="mb-6 text-white/90">
              Nuestros especialistas te asesorarán sobre el método más adecuado para tu tipo de piel y necesidades específicas.
            </p>
            <a 
