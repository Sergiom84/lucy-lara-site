...
app.use(helmet({
  contentSecurityPolicy: process.env.NODE_ENV === 'production' ? {
    directives: {
      ...
      connectSrc: ["'self'", "https://api.openai.com", "wss://lucia-lara-site.onrender.com"],
    ...
    directives: {
      ...
      connectSrc: ["'self'", "ws://localhost:*", "http://localhost:*", "https://api.openai.com"],
      frameSrc: ["'self'", "https:", "https://www.google.com", "https://maps.google.com"],
      objectSrc: ["'none'"],
      baseUri: ["'self'"]
    }
  },
